...
//wire  define
(* keep *)wire            sdram_wr_req    ;   //sdram 写请求
(* keep *)wire            sdram_wr_ack    ;   //sdram 写响应
(* keep *)wire    [23:0]  sdram_wr_addr   ;   //sdram 写地址
(* keep *)wire    [15:0]  sdram_data_in   ;   //写入sdram中的数据

(* keep *)wire            sdram_rd_req    ;   //sdram 读请求
(* keep *)wire            sdram_rd_ack    ;   //sdram 读响应
(* keep *)wire    [23:0]  sdram_rd_addr   ;   //sdram 读地址
(* keep *)wire    [15:0]  sdram_data_out  ;   //从sdram中读出的数据
